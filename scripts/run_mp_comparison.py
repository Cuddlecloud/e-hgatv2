...
population run processes 4*P individuals/generation, so the single-population BRKGA and the
attention-guided search are given pop_size = 4*P to equalise true evaluations per
generation; all methods use the same number of generations.
