"""scripts/run_real_fused_eval.py -- fused-TAPE evaluation on the REAL published instances.

Runs the physics-fused E-HGATv2 (max-plus DP makespan head + additive energy head) on the
real Homayouni & Fontes (2022) container-terminal instances in ``data/tables_4_5.json``
