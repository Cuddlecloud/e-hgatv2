"""scripts/run_landscape.py -- Module 6 entrypoint (Req 2: feature-importance landscape).
...
- optional TreeSHAP-vs-Sobol failure-boundary foil (``--shap``, Claim 3).
...
def main(args: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="E-HGATv2 landscape analysis (Req 2)")
