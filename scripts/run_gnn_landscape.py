"""scripts/run_gnn_landscape.py -- the scalable, model-native Req 2 landscape.
...
def main() -> None:
    p = argparse.ArgumentParser(description="Scalable GNN/TAPE Req 2 landscape.")
    ...
    for n in args.tasks:
        ...
        instance = build_toy_instance(num_tasks=n)  # uncoupled (the advisor's problem)
