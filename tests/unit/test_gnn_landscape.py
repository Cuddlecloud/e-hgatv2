"""Unit tests for the GNN/TAPE-derived feature-importance landscape (Req 2).

These exercise the model-native, scalable landscape: the same aggregator over TAPE
explanations from either the exact oracle (:func:`exact_landscape`) or the fused model
(:func:`gnn_landscape`), the per-family profile / Pareto-contrast structure, and the
