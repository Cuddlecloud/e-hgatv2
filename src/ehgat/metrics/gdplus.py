...
- **IGD+** (coverage + convergence): average over reference points of the ``d+`` from the
  nearest candidate -- "how well does the candidate cover PF*". IGD+ is the primary H1/H2
  quality number because it penalises both poor convergence and poor spread.
"""
