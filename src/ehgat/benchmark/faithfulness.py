"""H3 -- attention faithfulness against the *exact* critical path.
...
surrogate's **maximum-attention AGV arc** actually sits on it.
...
A faithful explainer scores high on both; the random/post-hoc baselines are the foil.
"""
