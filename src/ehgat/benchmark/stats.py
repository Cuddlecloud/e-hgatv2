"""Statistical analysis (Module 5c): significance + effect size for the AOS ablation.
...
Everything is pure numpy/scipy (no Torch), so it runs anywhere and is unit-testable
