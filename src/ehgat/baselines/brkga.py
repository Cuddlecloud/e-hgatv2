"""Multi-objective Biased Random-Key Genetic Algorithm baseline (Module 2).
...
NSGA-II of Module 4 is compared against. An external, unbounded Pareto archive tracks
the best non-dominated solutions across all generations, and a per-generation front
history supports the convergence (H1) analysis. The exact Oracle (``oracle.py``)
