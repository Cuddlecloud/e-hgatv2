...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Generalisation.} The surrogate is trained per instance. Demonstrating that a
  single surrogate \emph{transfers} the learned front behaviour to unseen instances (full
  amortisation) is the natural next step and would considerably strengthen R4.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
  ...
  concentrated the tension is (Section~\ref{sec:front}).
\end{itemize}
