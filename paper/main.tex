...
handling prior $\tilde x^{\mathrm{hand}}_j$). The leg \emph{energies}
...
\label{sec:tape}
Let $\pi^\star$ be the maximising path realised by the stored arcs $a^\star(\cdot)$. Along it
...
\begin{tabular}{lcccc}
\toprule
Method & avg.\ rank (HV) & avg.\ rank (GD$^+$) & TAPE vs.\ method, $p_{\text{Holm}}$ (HV) & Cliff's $\delta$ (HV)\\
\midrule
...
\midrule
\multicolumn{5}{l}{Friedman (HV): $\chi^2_4 = 28.9$, $p = 8.0\times10^{-6}$;\quad
Nemenyi $\mathrm{CD}_{0.05} = 1.84$.}\\
\multicolumn{5}{l}{Friedman (GD$^+$): $\chi^2_4 = 35.4$, $p = 3.8\times10^{-7}$;\quad
Cliff's $\delta$(GD$^+$, TAPE vs.\ mp-BRKGA) $=-0.57$ (large); TAPE $>$ mp-BRKGA on $11/11$.}\\
\bottomrule
\end{tabular}
\end{table}
