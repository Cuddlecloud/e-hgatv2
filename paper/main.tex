...
on \textsf{L21}, TAPE attains $0.940\pm0.015$ (CI $[0.925,0.955]$) versus mp-BRKGA
$0.742\pm0.044$ (CI $[0.698,0.786]$), with the gap far starker on the convergence indicator
($\mathrm{GD}^+$ $6.7\pm2.4$ vs.\ $79.8\pm19.2$); the same non-overlap holds on
\textsf{L15} ($0.941\pm0.014$ vs.\ $0.849\pm0.032$) and \textsf{SD-15}
($0.866\pm0.020$ vs.\ $0.759\pm0.027$). On the near-optimal small instances ($N\le10$) the
